...
//
// 'build_event_insert_edit_table       - return code to display code to insert and edit events
...
#####################  build_event_insert_edit_table ####################

if ($helper_type == "build_event_insert_edit_table") {
...
// given society. STart by building an insert row



    $sql = "SELECT *  FROM cba_events
                WHERE
